...
C_SOURCES += Middlewares/ISP_Library/isp/Src/isp_algo.c
C_SOURCES += Middlewares/ISP_Library/isp/Src/isp_cmd_parser.c
C_SOURCES += Middlewares/ISP_Library/isp/Src/isp_core.c
C_SOURCES += Middlewares/ISP_Library/isp/Src/isp_services.c
C_SOURCES += Middlewares/ISP_Library/isp/Src/isp_tool_com.c
...
C_INCLUDES += -IMiddlewares/ISP_Library/evision/Inc
C_INCLUDES += -IMiddlewares/ISP_Library/isp/Inc
...
# libraries
LIBS = -lc -lm -lnosys -ln6-evision-awb_gcc -ln6-evision-st-ae_gcc
LIBDIR += -LMiddlewares/ISP_Library/evision/Lib
